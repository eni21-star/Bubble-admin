...
popupStatusRouter
.put('/popup/status', [authMiddleware, permissionsMiddleware('update_popup'), reqValidator(PopupStatusDto)], popupStatusController.changeStatus.bind(popupStatusController))
