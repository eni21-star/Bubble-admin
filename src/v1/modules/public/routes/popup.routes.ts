...
popupRouter
  .post(
    "/popup/create",
    reqValidator(CreatePopupDto),
    popupController.createPopup.bind(popupController)
  )
  .put(
    "/popup/update/:id",
    [
      ...
      reqValidator(UpdatePopupDto),
    ],
    popupController.updatePopup.bind(popupController)
  )
  //.get('/popups', popupController.getAllPopups.bind(popupController))
  .get(
    "/popup/:id",
    validateIdParams,
    popupController.getPopupById.bind(popupController)
  );
