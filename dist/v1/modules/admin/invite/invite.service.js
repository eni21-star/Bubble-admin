...
let InviteService = class InviteService {
    ...
    async sendInvite(admin, data) {
        try {
            ...
            if (invitationSent === null || invitationSent === void 0 ? void 0 : invitationSent.invitationTokenUsed) {
    ...
    async acceptInvite(token, data) {
        try {
            ...
            if (findInvite === null || findInvite === void 0 ? void 0 : findInvite.invitationTokenUsed) {
                throw new errors_1.ForbiddenError('You have already taken this action.');
            }
