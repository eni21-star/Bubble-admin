...
const careers_routes_1 = __importDefault(require("./v1/modules/admin/careers/careers.routes"));
const file_parser_routes_1 = __importDefault(require("./v1/modules/admin/file-parser/file-parser.routes"));
const popup_routes_1 = __importDefault(require("./v1/modules/admin/popup/popup.routes"));
const helmet_1 = __importDefault(require("helmet"));
const cors_1 = __importDefault(require("cors"));
const suscribe_routes_1 = __importDefault(require("./v1/modules/admin/subscribe/suscribe.routes"));
