...
const refreshToken_datasource_1 = __importDefault(require("../admin/datasource/refreshToken.datasource"));
const auth_datasource_1 = __importDefault(require("../admin/datasource/auth.datasource"));
let AuthService = class AuthService {
    ...
    async register(data) {
        try {
            ...
            logger_1.logger.info(role);
            if (role == 'ADMIN') {
                data.permissions = permissions_config_1.defaultPermissions;
            }
            else {
                data.permissions = permissions_config_1.superAdminPermissions;
            }
