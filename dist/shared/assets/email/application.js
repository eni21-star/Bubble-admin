...
const sendMailer = async (applicantName, applicantEmail, applicantumber, file) => {
    try {
      ...
      <div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            <th style="text-align: left; padding: 8px; background-color: #f2f2f2;">Position Applied For:</th>
            <td style="padding: 8px;">${applicantumber}</td>
          </tr>
        </table>
