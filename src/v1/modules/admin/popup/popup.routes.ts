...
import PopupController from './popup.controllers'
...
popupRouter
.post('/popup/create', [authMiddleware, permissionsMiddleware('create_popup'), reqValidator(CreatePopupDto)], popupController.createPopup.bind(popupController))
