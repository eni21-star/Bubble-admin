...
.get(`/support/get-ticket/:id`, authMiddleware,  supportController.getTicket.bind(supportController))
...
.get('/support/open-tickets', authMiddleware, supportController.getAllOpenTickets.bind(supportController))
