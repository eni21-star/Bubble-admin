...
const authMiddleware = (req, res, next) => {
    var _a, _b;
    try {
        const token = (((_b = (_a = req === null || req === void 0 ? void 0 : req.headers) === null || _a === void 0 ? void 0 : _a.authorization) === null || _b === void 0 ? void 0 : _b.startsWith('Bearer ')) ? req.headers.authorization.substring(7) : null);
        if (!token)
